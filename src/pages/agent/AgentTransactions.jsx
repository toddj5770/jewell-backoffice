...
import { fmt$, statusBadge, calcCommission } from '../../lib/commission'
    ...
    <div>
      ...
      <div className="card">
        <div className="tbl-wrap">
          <table>
            <thead><tr><th>Property</th><th>Type</th><th>My Split</th><th>My Commission</th><th>Close Date</th><th>Status</th></tr></thead>
            <tbody>
              {rows.map(ta => {
                const t = ta.transactions; if(!t) return null
              ...
              {rows.length===0&&<tr><td colSpan={6} style={{textAlign:'center',color:'var(--txt3)',padding:30}}>No transactions yet.</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
